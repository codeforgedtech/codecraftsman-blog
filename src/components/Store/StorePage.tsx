...
const StorePage: React.FC = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
     ...
     {
      id: 3,
      name: "The Compile Abyss(CD)",
      price: "6,00 €",
      image: "https://codecraftsman.se/store/compile.png",
      description: "A darkwave journey through burnout, broken code, and the silence of failed compiles. A soundtrack for those who debug in the dark.",
      category: "Records",
      stock: 10,
      unitLabel: "pcs",
      unitMultiplier: 1,
