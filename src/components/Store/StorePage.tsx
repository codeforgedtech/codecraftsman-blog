  ...
  return (
    <div className="bg-black min-h-screen text-white font-sans px-4 py-8 flex items-start justify-start w-screen">
      <div className="w-full max-w-6xl">
        ...
        <div className="mb-4">
          <label htmlFor="category-filter" className="block text-cyan-400 mb-2">Filter by Category:</label>
          <select
            id="category-filter"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col justify-between">
          ...
          {selectedProduct.sizes && (
            <div className="mb-6">
              <label className="block text-gray-300 text-lg mb-2">Select Size:</label>
              <select
