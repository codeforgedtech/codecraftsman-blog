    ...
    something new — welcome to my musical experiments.
            ...
            <section>
              ...
              <div className="space-y-12">
                {/* Album 1: Runtime Ghosts */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Runtime Ghosts</h3>
                  <div className="w-full">
                    <iframe
                      ...
                      frameBorder="no"
                      allow="autoplay"
                      src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/2063145678&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"
                    ></iframe>
                    <div
                      style={{
                        fontSize: "10px",
                    ...
                    >
                      ...
                      ·{" "}
                      <a
                        href="https://soundcloud.com/codecraftsman/sets/runtime-ghosts"
                ...
                {/* Album 2: The Compile Abyss */}
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">The Compile Abyss</h3>
                  <div className="w-full">
                    <iframe
                      width="100%"
                      height="450"
                      ...
                      frameBorder="no"
                      allow="autoplay"
                      src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/2059610679&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"
                    ></iframe>
                    <div
                      style={{
                        fontSize: "10px",
                    ...
                    >
                      ...
                      ·{" "}
                      <a
                        href="https://soundcloud.com/codecraftsman/sets/the-compile-abyss"
