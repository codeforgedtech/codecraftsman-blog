...
const ContactPage = () => {
  ...
  const Input = (props: React.InputHTMLAttributes<HTMLInputElement> & { label: string; id: string }) => (
    <div>
  ...
  const TextArea = (props: React.TextareaHTMLAttributes<HTMLTextAreaElement> & { label: string; id: string }) => (
    <div>
      <label htmlFor={props.id} className="block text-sm font-medium text-gray-300 mb-1">
        {props.label}
      </label>
        ...
        <div className="mt-6 rounded-2xl p-[1px] bg-gradient-to-br from-cyan-500/30 via-white/10 to-transparent">
          <div className="rounded-2xl bg-gradient-to-b from-slate-900 to-black p-6 ring-1 ring-white/10 shadow-2xl text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-5">
              <a href="https://github.com/codeforgedtech" target="_blank" rel="noopener noreferrer" className="transform hover:scale-105 transition-transform duration-300">
                <img src="https://img.shields.io/github/followers/codeforgedtech?style=social" alt="GitHub Followers" className="h-6" />
              </a>
              <a href="https://github.com/codeforgedtech" target="_blank" rel="noopener noreferrer" className="transform hover:scale-105 transition-transform duration-300">
                <img src="https://img.shields.io/github/stars/codeforgedtech?style=social" alt="GitHub Stars" className="h-6" />
              </a>
              <img src="https://img.shields.io/github/last-commit/codeforgedtech/codecraftsman-blog?style=social" alt="Last commit" className="h-6" />
              <img src="https://img.shields.io/github/forks/codeforgedtech/codecraftsman-blog?style=social" alt="GitHub Forks" className="h-6" />
              <img src="https://img.shields.io/github/license/codeforgedtech/codecraftsman-blog?style=social" alt="GitHub License" className="h-6" />
            </div>
          </div>
        </div>
      </div>
